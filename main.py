...
student_2 = Student('Петр', 'Васильевич', 'Male')
student_2.finished_courses = ['С++', 'Git']
student_2.courses_in_progress = ['Python', 'Java']
students_list = [student_1, student_2]

lecturer_1 = Lecturer('Евгений', 'Захвыстов')
lecturer_1.courses_attached = ['Git', 'Java']

lecturer_2 = Lecturer('Олег', 'Монгол')
lecturer_2.courses_attached = ['Python']
lecturer_list = [lecturer_1, lecturer_2]

reviewer_1 = Reviewer('Алексей', 'Ручкин')
reviewer_1.courses_attached = ['Python', 'С++', 'Java', 'Git']

reviewer_2 = Reviewer('Владимир', 'Селиванов')
